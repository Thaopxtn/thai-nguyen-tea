...
export async function getProductById(id) {
    try {
        ...
        return {
            ...
            reviews: p.reviews, // Include reviews if needed
            // date: p.date, // Product might not have date, omit for now
        };
    } catch (e) {
        console.warn("DB Error (getProductById), returning MOCK data", e.message);
